...
function JetpackLikesMessageListener( event, message ) {
	...
	allowedOrigin = window.location.protocol + '//web.archive.org/web/20190330063810/https://widgets.wp.com';
...
jQuery( function() {
	...
	$( 'body' ).on( 'click', 'a.comment-like-link', function( $e ) {
		if ( $( $e.target ).hasClass( 'needs-login' ) ) {
			...
			var url = 'https://web.archive.org/web/20190330063810/https://wordpress.com/public.api/connect/?action=request&service=wordpress';
			...
			loginIframe.attr( "src", "https://web.archive.org/web/20190330063810/https://wordpress.com/public.api/connect/?iframe=true" );
...
( function( $ ) {
	...
	$( window ).on( 'message', function( e ) {
		...
		if ( event.origin !== 'https://web.archive.org/web/20190330063810/https://widgets.wp.com' ) {
			return;
		}
...
(function($){
	...
	if ( ! fbd.canCustomizeSite ) {
		// Report Link
		reporthtml = '<li class="flb-report"><a href="https://web.archive.org/web/20190330063810/http://en.wordpress.com/abuse/">' + fbd.i18n.report + '</a></li>';
	}
	...
	if ( fbd.isLoggedIn ) {
		...
		if ( fbd.canFollow ) {
			if ( fbd.isSingular ) {
				viewReaderHtml = '<li class="actnbr-reader"><a href="https://web.archive.org/web/20190330063810/https://wordpress.com/read/blogs/' + fbd.siteID + '/posts/' + fbd.postID +'">' + fbd.i18n.viewReadPost + '</a></li>';
			} else {
				viewReaderHtml = '<li class="actnbr-reader"><a href="https://web.archive.org/web/20190330063810/https://wordpress.com/read/' + ( fbd.feedID ? 'feeds/' + fbd.feedID : 'blogs/' + fbd.siteID ) + '">' + fbd.i18n.viewReader + '</a></li>';
			}
		}
		editFollowsHtml = '<li class="actnbr-follows"><a href="https://web.archive.org/web/20190330063810/https://wordpress.com/following/edit">' + fbd.i18n.editSubs + '</a></li>';
	} else {
		...
		editSubsHtml = '<li class="actnbr-subs"><a href="https://web.archive.org/web/20190330063810/https://subscribe.wordpress.com/">' + fbd.i18n.editSubs + '</a></li>';
	}
	...
	function showActionBarFollowForm() {
		...
		form.attr('action', 'https://web.archive.org/web/20190330063810/https://subscribe.wordpress.com');
...
/*
     FILE ARCHIVED ON 06:38:10 Mar 30, 2019 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 13:23:31 Aug 30, 2026.
...
playback timings (ms):
  ...
  load_resource: 238.804 (2)
  PetaboxLoader3.resolve: 85.728 (2)
  PetaboxLoader3.datanode: 58.929 (2)
*/
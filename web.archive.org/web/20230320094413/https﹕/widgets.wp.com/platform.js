...
href=href.substr(0,href.length-1);var iframe=document.createElement('iframe');var iframe_url='//web.archive.org/web/20230320094413/https://widgets.wp.com/timeline/index.html';iframe_url+='#blog='+href;iframe_url+=((null==timeline.getAttribute('lang'))?'':'&lang='+timeline.getAttribute('lang'));iframe_url+=((null==timeline.getAttribute('data-theme'))?'&theme=light':'&theme='+timeline.getAttribute('data-theme'));iframe_url+=((null==timeline.getAttribute('data-link-color'))?'':'&link_color='+timeline.getAttribute('data-link-color'));iframe_url+=((null==timeline.getAttribute('data-show-gravatars'))?'':'&show_gravatars='+timeline.getAttribute('data-show-gravatars'));iframe_url+='&width='+width;iframe_url+='&height='+height;iframe.setAttribute('src',iframe_url);iframe.setAttribute('width',width);iframe.setAttribute('height',height);iframe.setAttribute('frameborder','0');iframe.setAttribute('scrolling','no');timeline.parentNode.replaceChild(iframe,timeline);}
...
href=href.substring(8);if(href.indexOf('http://')==0)
href=href.substring(7);if(href.substr(-1)=='/')
href=href.substr(0,href.length-1);var iframe=document.createElement('iframe');var iframe_url='//web.archive.org/web/20230320094413/https://widgets.wp.com/follow/index.html';iframe_url+='#href='+href;iframe_url+=((null==button.getAttribute('data-lang'))?'':'&lang='+button.getAttribute('data-lang'));iframe_url+=((null==button.getAttribute('data-blog'))?'':'&blog='+encodeURIComponent(button.getAttribute('data-blog')));iframe_url+=((null==button.getAttribute('data-show-follower-count'))?'':'&show_follower_count='+encodeURIComponent(button.getAttribute('data-show-follower-count')));iframe_url+=((null==button.getAttribute('data-show-blog-name'))?'':'&show_blog_name='+encodeURIComponent(button.getAttribute('data-show-blog-name')));iframe.setAttribute('src',iframe_url);iframe.setAttribute('width',width);iframe.setAttribute('height',height);iframe.setAttribute('frameborder','0');iframe.setAttribute('scrolling','no');button.parentNode.replaceChild(iframe,button);}
var arg,embedArgs,iframe,iframeURL,s,uniqueID,wpEmbed,wpembeds=getElementsByClassName('wordpress-wpembed'),wpembedsCounter=0;for(i=0;i<wpembeds.length;i++){embedArgs={};iframe=document.createElement('iframe');iframeURL='https://web.archive.org/web/20230320094413/https://widgets.wp.com/wpembed/index.html?';uniqueID=0;wpembed=wpembeds[i];embedArgs.gravatars=(wpembed.getAttribute('data-show-gravatars')==='false')?false:true;embedArgs.language=wpembed.getAttribute('data-lang')||'en';embedArgs.theme=(wpembed.getAttribute('data-theme')==='dark')?'dark':'light';embedArgs.host=wpembed.getAttribute('data-host');if(wpembed.getAttribute('data-comment-id')){embedArgs.commentID=parseInt(wpembed.getAttribute('data-comment-id'),10);}else if(wpembed.getAttribute('data-post-id')){embedArgs.postID=parseInt(wpembed.getAttribute('data-post-id'),10);}else if(wpembed.getAttribute('data-post-name')){embedArgs.postName=wpembed.getAttribute('data-post-name');}
...
window.addEventListener('message',function(message){if(message.origin!=='https://web.archive.org/web/20230320094413/https://widgets.wp.com'){return;}
...
/*
     FILE ARCHIVED ON 09:44:13 Mar 20, 2023 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 13:22:45 Aug 30, 2026.
...
playback timings (ms):
  ...
  load_resource: 72.0
  PetaboxLoader3.resolve: 50.379
  PetaboxLoader3.datanode: 20.621
*/
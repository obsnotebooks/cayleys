...
function JetpackLikesMessageListener( event ) {
	...
	const allowedOrigin = 'https://web.archive.org/web/20230321081634/https://widgets.wp.com';
...
(function () {
	function init() {
		...
		function startPolling() {
			...
			loginIframe.src = 'https://web.archive.org/web/20230321081634/https://wordpress.com/public.api/connect/?iframe=true';
		...
		document.body.addEventListener('click', e => {
			...
			if (target.classList.contains('needs-login')) {
				...
				const url = 'https://web.archive.org/web/20230321081634/https://wordpress.com/public.api/connect/?action=request&service=wordpress';
				extWin = window.open(
					url,
					'likeconn',
...
( function () {
	...
	window.addEventListener( 'message', function ( event ) {
		if ( event.origin !== 'https://web.archive.org/web/20230321081634/https://widgets.wp.com' ) {
			return;
		}
...
( function () {
	...
	var stat = function ( names ) {
		...
		new Image().src = window.location.protocol +
			'//web.archive.org/web/20230321081634/https://pixel.wp.com/g.gif?v=wpcom-no-pv' +
			'&x_carousel=' + names +
			'&baba=' + Math.random();
	};
	...
	var pageview = function ( post_id ) {
		new Image().src = window.location.protocol +
			'//web.archive.org/web/20230321081634/https://pixel.wp.com/g.gif?host=' + encodeURIComponent( window.location.host ) +
...
/*
     FILE ARCHIVED ON 08:16:34 Mar 21, 2023 AND RETRIEVED FROM THE
...
/*
playback timings (ms):
  capture_cache.get: 1.749
  load_resource: 348.614
  PetaboxLoader3.resolve: 222.869
  PetaboxLoader3.datanode: 70.664 (2)
  loaddict: 95.218
*/
...
function JetpackLikesMessageListener( event ) {
	...
	const allowedOrigin = 'https://web.archive.org/web/20230602151719/https://widgets.wp.com';
...
( function () {
	...
	var stat = function ( names ) {
		...
		new Image().src = window.location.protocol +
			'//web.archive.org/web/20230602151719/https://pixel.wp.com/g.gif?v=wpcom-no-pv' +
			'&x_carousel=' + names +
			'&baba=' + Math.random();
	};
	...
	var pageview = function ( post_id ) {
		new Image().src = window.location.protocol +
			'//web.archive.org/web/20230602151719/https://pixel.wp.com/g.gif?host=' + encodeURIComponent( window.location.host ) +
...
/*
     FILE ARCHIVED ON 15:17:19 Jun 02, 2023 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 13:25:11 Aug 30, 2026.
...
/*
playback timings (ms):
  capture_cache.get: 0.316
  load_resource: 1343.316
  PetaboxLoader3.resolve: 1302.993
  PetaboxLoader3.datanode: 17.903
*/
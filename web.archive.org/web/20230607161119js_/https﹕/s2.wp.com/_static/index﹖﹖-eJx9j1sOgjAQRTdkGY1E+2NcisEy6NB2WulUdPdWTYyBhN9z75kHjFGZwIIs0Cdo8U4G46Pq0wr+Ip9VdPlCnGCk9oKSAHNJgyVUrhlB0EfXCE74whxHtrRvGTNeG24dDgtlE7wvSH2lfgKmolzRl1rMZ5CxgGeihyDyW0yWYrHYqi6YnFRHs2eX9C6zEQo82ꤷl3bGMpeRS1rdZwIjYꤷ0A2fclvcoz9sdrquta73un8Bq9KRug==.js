...
function JetpackLikesMessageListener( event ) {
	...
	const allowedOrigin = 'https://web.archive.org/web/20230607161119/https://widgets.wp.com';
...
(function () {
	function init() {
		...
		function startPolling() {
			...
			loginIframe.src = 'https://web.archive.org/web/20230607161119/https://wordpress.com/public.api/connect/?iframe=true';
		...
		document.body.addEventListener('click', e => {
			...
			if (target.classList.contains('needs-login')) {
				...
				const url = 'https://web.archive.org/web/20230607161119/https://wordpress.com/public.api/connect/?action=request&service=wordpress';
				extWin = window.open(
					url,
					'likeconn',
...
/*
     FILE ARCHIVED ON 16:11:19 Jun 07, 2023 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 13:24:01 Aug 30, 2026.
...
playback timings (ms):
  ...
  load_resource: 78.508
  PetaboxLoader3.resolve: 48.023
  PetaboxLoader3.datanode: 10.727
*/
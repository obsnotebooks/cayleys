...
function JetpackLikesMessageListener( event, message ) {
	...
	allowedOrigin = window.location.protocol + '//web.archive.org/web/20190402001042/https://widgets.wp.com';
...
jQuery( function() {
	...
	$( 'body' ).on( 'click', 'a.comment-like-link', function( $e ) {
		if ( $( $e.target ).hasClass( 'needs-login' ) ) {
			...
			var url = 'https://web.archive.org/web/20190402001042/https://wordpress.com/public.api/connect/?action=request&service=wordpress';
			...
			loginIframe.attr( "src", "https://web.archive.org/web/20190402001042/https://wordpress.com/public.api/connect/?iframe=true" );
...
( function( $ ) {
	...
	$( window ).on( 'message', function( e ) {
		...
		if ( event.origin !== 'https://web.archive.org/web/20190402001042/https://widgets.wp.com' ) {
			return;
		}
...
(function($){
	...
	if ( ! fbd.canCustomizeSite ) {
		// Report Link
		reporthtml = '<li class="flb-report"><a href="https://web.archive.org/web/20190402001042/http://en.wordpress.com/abuse/">' + fbd.i18n.report + '</a></li>';
	}
	...
	if ( fbd.isLoggedIn ) {
		...
		if ( fbd.canFollow ) {
			if ( fbd.isSingular ) {
				viewReaderHtml = '<li class="actnbr-reader"><a href="https://web.archive.org/web/20190402001042/https://wordpress.com/read/blogs/' + fbd.siteID + '/posts/' + fbd.postID +'">' + fbd.i18n.viewReadPost + '</a></li>';
			} else {
				viewReaderHtml = '<li class="actnbr-reader"><a href="https://web.archive.org/web/20190402001042/https://wordpress.com/read/' + ( fbd.feedID ? 'feeds/' + fbd.feedID : 'blogs/' + fbd.siteID ) + '">' + fbd.i18n.viewReader + '</a></li>';
			}
		}
		editFollowsHtml = '<li class="actnbr-follows"><a href="https://web.archive.org/web/20190402001042/https://wordpress.com/following/edit">' + fbd.i18n.editSubs + '</a></li>';
	} else {
		...
		editSubsHtml = '<li class="actnbr-subs"><a href="https://web.archive.org/web/20190402001042/https://subscribe.wordpress.com/">' + fbd.i18n.editSubs + '</a></li>';
	}
	...
	function showActionBarFollowForm() {
		...
		form.attr('action', 'https://web.archive.org/web/20190402001042/https://subscribe.wordpress.com');
...
wpcom.carousel = (function(/*$*/) {
	...
	var stat = function ( names ) {
		...
		new Image().src = window.location.protocol +
			'//web.archive.org/web/20190402001042/https://pixel.wp.com/g.gif?v=wpcom-no-pv' +
			'&x_carousel=' + names +
			'&baba=' + Math.random();
	};
	...
	var pageview = function ( post_id ) {
		new Image().src = window.location.protocol +
			'//web.archive.org/web/20190402001042/https://pixel.wp.com/g.gif?host=' + encodeURIComponent( window.location.host ) +
...
// @end-hide-in-jetpack
			...
			container.attr('itemtype', 'https://web.archive.org/web/20190402001042/https://schema.org/ImageGallery');
		...
		selectSlide : function(slide, animate){
			...
			if ( jetpackCarouselStrings.stats ) {
				new Image().src = document.location.protocol +
					'//web.archive.org/web/20190402001042/https://pixel.wp.com/g.gif?' +
...
// @end-hide-in-jetpack
			...
			items.each(function(i){
				...
				if ( attachment_id && orig_size.length ) {
					...
					var slide = $('<div class="jp-carousel-slide" itemprop="associatedMedia" itemscope itemtype="https://web.archive.org/web/20190402001042/https://schema.org/ImageObject"></div>')
							.hide()
							.css({
								//'position' : 'fixed',
...
// @end-hide-in-jetpack
		...
		updateMap: function( meta ) {
			...
			$mapbox
				...
				.html( '<img width="154" height="154" src="https://web.archive.org/web/20190402001042/https://maps.googleapis.com/maps/api/staticmap?\
							...
							\
						<div class="gmap-topright"><div class="imgclip"><img width="175" height="154" src="https://web.archive.org/web/20190402001042/https://maps.googleapis.com/maps/api/staticmap?\
							center=' + latitude + ',' + longitude + '&\
							zoom=3&\
							size=175x154&\
							sensor=false&\
...
if ( sharing_js_options && sharing_js_options.counts ) {
	var WPCOMSharing = {
			...
			for ( url in WPCOM_sharing_counts ) {
				...
				requests = {
					...
					pinterest: [
						...
						'//web.archive.org/web/20190402001042/https://api.pinterest.com/v1/urls/count.json?callback=WPCOMSharing.update_pinterest_count&url=' +
						encodeURIComponent( url )
					],
					// Facebook protocol summing has been shown to falsely double counts, so we only request the current URL
					facebook: [
						window.location.protocol +
						'//web.archive.org/web/20190402001042/https://graph.facebook.com/?callback=WPCOMSharing.update_facebook_count&ids=' +
						encodeURIComponent( url )
					]
				};
		...
		bump_sharing_count_stat: function( service ) {
			new Image().src = document.location.protocol + '//web.archive.org/web/20190402001042/https://pixel.wp.com/g.gif?v=wpcom-no-pv&x_sharing-count-request=' + service + '&r=' + Math.random();
		}
	};
}
...
/*
     FILE ARCHIVED ON 00:10:42 Apr 02, 2019 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 13:23:43 Aug 30, 2026.
...
/*
playback timings (ms):
  capture_cache.get: 0.374
  load_resource: 512.308 (2)
  PetaboxLoader3.resolve: 463.991 (2)
  PetaboxLoader3.datanode: 11.71 (2)
*/
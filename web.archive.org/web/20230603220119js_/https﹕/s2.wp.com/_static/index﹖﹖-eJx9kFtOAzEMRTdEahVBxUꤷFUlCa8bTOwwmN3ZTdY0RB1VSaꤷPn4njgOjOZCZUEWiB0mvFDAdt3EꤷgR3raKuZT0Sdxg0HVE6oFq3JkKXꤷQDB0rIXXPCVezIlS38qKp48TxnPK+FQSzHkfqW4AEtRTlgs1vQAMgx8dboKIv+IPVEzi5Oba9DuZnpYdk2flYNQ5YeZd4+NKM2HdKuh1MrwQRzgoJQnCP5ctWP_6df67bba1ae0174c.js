...
function JetpackLikesMessageListener( event ) {
	...
	const allowedOrigin = 'https://web.archive.org/web/20230603220119/https://widgets.wp.com';
...
(function () {
	function init() {
		...
		function startPolling() {
			...
			loginIframe.src = 'https://web.archive.org/web/20230603220119/https://wordpress.com/public.api/connect/?iframe=true';
		...
		document.body.addEventListener('click', e => {
			...
			if (target.classList.contains('needs-login')) {
				...
				const url = 'https://web.archive.org/web/20230603220119/https://wordpress.com/public.api/connect/?action=request&service=wordpress';
				extWin = window.open(
					url,
					'likeconn',
...
( function () {
	...
	var stat = function ( names ) {
		...
		new Image().src = window.location.protocol +
			'//web.archive.org/web/20230603220119/https://pixel.wp.com/g.gif?v=wpcom-no-pv' +
			'&x_carousel=' + names +
			'&baba=' + Math.random();
	};
	...
	var pageview = function ( post_id ) {
		new Image().src = window.location.protocol +
			'//web.archive.org/web/20230603220119/https://pixel.wp.com/g.gif?host=' + encodeURIComponent( window.location.host ) +
...
/*
     FILE ARCHIVED ON 22:01:19 Jun 03, 2023 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 13:23:27 Aug 30, 2026.
...
playback timings (ms):
  ...
  PetaboxLoader3.resolve: 34.039
  PetaboxLoader3.datanode: 9.96
*/
...
function JetpackLikesMessageListener( event ) {
	...
	const allowedOrigin = 'https://web.archive.org/web/20230203202222/https://widgets.wp.com';
...
(function () {
	function init() {
		...
		function startPolling() {
			...
			loginIframe.src = 'https://web.archive.org/web/20230203202222/https://wordpress.com/public.api/connect/?iframe=true';
		...
		document.body.addEventListener('click', e => {
			...
			if (target.classList.contains('needs-login')) {
				...
				const url = 'https://web.archive.org/web/20230203202222/https://wordpress.com/public.api/connect/?action=request&service=wordpress';
				extWin = window.open(
					url,
					'likeconn',
...
( function () {
	...
	window.addEventListener( 'message', function ( event ) {
		if ( event.origin !== 'https://web.archive.org/web/20230203202222/https://widgets.wp.com' ) {
			return;
		}
...
( function () {
	...
	var stat = function ( names ) {
		...
		new Image().src = window.location.protocol +
			'//web.archive.org/web/20230203202222/https://pixel.wp.com/g.gif?v=wpcom-no-pv' +
			'&x_carousel=' + names +
			'&baba=' + Math.random();
	};
	...
	var pageview = function ( post_id ) {
		new Image().src = window.location.protocol +
			'//web.archive.org/web/20230203202222/https://pixel.wp.com/g.gif?host=' + encodeURIComponent( window.location.host ) +
...
playback timings (ms):
  ...
  load_resource: 79.884
  PetaboxLoader3.resolve: 33.236
  PetaboxLoader3.datanode: 29.191
*/
...
function JetpackLikesMessageListener( event, message ) {
	...
	allowedOrigin = window.location.protocol + '//web.archive.org/web/20210818170937/https://widgets.wp.com';
...
jQuery( function() {
	...
	$( 'body' ).on( 'click', 'a.comment-like-link', function( $e ) {
		if ( $( $e.target ).hasClass( 'needs-login' ) ) {
			...
			var url = 'https://web.archive.org/web/20210818170937/https://wordpress.com/public.api/connect/?action=request&service=wordpress';
			...
			loginIframe.attr( "src", "https://web.archive.org/web/20210818170937/https://wordpress.com/public.api/connect/?iframe=true" );
...
( function () {
	...
	window.addEventListener( 'message', function ( event ) {
		if ( event.origin !== 'https://web.archive.org/web/20210818170937/https://widgets.wp.com' ) {
			return;
		}
		...
		var WPCOMSharing = {
					...
					requests = {
						...
						pinterest: [
							window.location.protocol +
								'//web.archive.org/web/20210818170937/https://api.pinterest.com/v1/urls/count.json?callback=WPCOMSharing.update_pinterest_count&url=' +
								encodeURIComponent( url ),
						],
						// Facebook protocol summing has been shown to falsely double counts, so we only request the current URL
						facebook: [
							window.location.protocol +
								'//web.archive.org/web/20210818170937/https://graph.facebook.com/?callback=WPCOMSharing.update_facebook_count&ids=' +
								encodeURIComponent( url ),
						],
					};
			...
			bump_sharing_count_stat: function ( service ) {
				new Image().src =
					...
					'//web.archive.org/web/20210818170937/https://pixel.wp.com/g.gif?v=wpcom-no-pv&x_sharing-count-request=' +
					service +
					'&r=' +
					Math.random();
			},
...
/*
     FILE ARCHIVED ON 17:09:37 Aug 18, 2021 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 13:25:35 Aug 30, 2026.
...
/*
playback timings (ms):
  capture_cache.get: 0.459
  load_resource: 992.797 (2)
  PetaboxLoader3.resolve: 183.185 (2)
  PetaboxLoader3.datanode: 758.834 (2)
*/